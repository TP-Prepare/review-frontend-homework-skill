...
1. **Старт (Фаза 0):** определяет владельца PR, находит имя и контакт
   ментора и, после подтверждения, ассайнится на PR — до того, как начнётся
   долгая проверка кода
2. Собирает контекст PR: метаданные, diff, статус CI, задание варианта,
...
берём, контакт ментора и ассайн. Дальше доходит до черновика и останавливается
снова: прочитай, поправь формулировки при необходимости, скажи «постим» — и
он опубликует.
